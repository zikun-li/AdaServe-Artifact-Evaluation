...
#SBATCH --job-name=qwen_prop
#SBATCH --output=qwen/evaluation_out_${SCALING_FACTOR}.txt
#SBATCH --error=qwen/evaluation_error_${SCALING_FACTOR}.err
...
export OUTPUT_DIR=$REPO_DIR/results/fig10/qwen/
